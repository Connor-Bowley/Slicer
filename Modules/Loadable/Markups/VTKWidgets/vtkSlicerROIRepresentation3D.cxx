...
vtkSlicerROIRepresentation3D::vtkSlicerROIRepresentation3D()
{
  ...
  this->ROIProperty->DeepCopy(this->ControlPointsPipelines.GetProperty(Selected));
  ...
  this->ROIOutlineProperty->DeepCopy(this->ControlPointsPipelines.GetProperty(Selected));
...
void vtkSlicerROIRepresentation3D::UpdateFromMRML(vtkMRMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  ...
  this->ROIProperty->DeepCopy(this->ControlPointsPipelines.GetProperty(controlPointType));
  ...
  this->ROIOutlineProperty->DeepCopy(this->ControlPointsPipelines.GetProperty(controlPointType));
