...
vtkSlicerPlaneRepresentation3D::vtkSlicerPlaneRepresentation3D()
{
  ...
  this->PlaneActor->SetProperty(this->ControlPointsPipelines.GetProperty(Unselected));

  this->PlaneOccludedActor->SetMapper(this->PlaneOccludedMapper);
  this->PlaneOccludedActor->SetProperty(this->ControlPointsPipelines.GetOccludedProperty(Unselected));
}
...
void vtkSlicerPlaneRepresentation3D::UpdateFromMRML(vtkMRMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  ...
  this->PlaneActor->SetProperty(this->ControlPointsPipelines.GetProperty(controlPointType));
  this->PlaneOccludedActor->SetProperty(this->ControlPointsPipelines.GetOccludedProperty(controlPointType));
  ...
  double color[3] = { 0.0 };
  this->ControlPointsPipelines.GetProperty(controlPointType)->GetColor(color);
  double opacity = this->ControlPointsPipelines.GetProperty(controlPointType)->GetOpacity();
